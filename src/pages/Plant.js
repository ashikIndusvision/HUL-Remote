...
import { clientLogo, plantImages } from "../config";
...
const Organisation = () => {
  ...
  const handlepost = () => {
    ...
    if (formData.organization_logo === "") {
      setError((prev) => ({
        ...prev,
        imageError: "Please Enter Organization namre",
      }));
    } else {
      ...
      >
        ...
        >
          <div className="slider-container">
            <Slider {...settings}>
              {plantImages.slice(0, 4).map((item) => {
                return (
                  <div className="image_wrapper" key={item}>
                    <img
                      style={{
                        height: "100%",
                        width: "200px",
        ...
        >
          ...
          >
            <Col
              ...
              style={{ display: "flex", justifyContent: "center" }}
            >
              <img style={{ width: "50%" }} src={clientLogo} alt="" />
            </Col>
          </Row>
          {loader ? (
            <div
        ...
        <Col span={5} style={{ display: "flex", justifyContent: "center" }}>
          <div className="slider-container">
            <Slider {...settings}>
              <div className="slider-container">
                <Slider {...settings}>
                  {plantImages.slice(4, 9).map((item) => {
                    return (
                      <div className="image_wrapper" key={item}>
                        <img
                          style={{
